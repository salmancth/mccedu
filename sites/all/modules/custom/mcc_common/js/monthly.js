		...
		$(document.body).on("click touchstart", parent + " .monthly-day", function (event) {
			...
			if(options.mode === "event" && options.eventList) {
				...
				theList.css("transform", "scale(1)");
                                // next line added to hide all other events when particular day is clicked - IMN
                                $(parent + ' .monthly-event-list .monthly-list-item').hide();
                                // prev line added to hide all other events when particular day is clicked - IMN
