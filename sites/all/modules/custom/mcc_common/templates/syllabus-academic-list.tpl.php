      ...
      <h1 class="text-center">
        ...
        if ($edit_permission) {
          ...
          <span class="label label-primary">
            <a href="/academic-syllabus/department-edit/<?php echo $dept_id . '/' . $lang; ?>">EDIT</a>
          </span>
          <?php
        }
        ?>
              ...
              <div class="panel-wrapper collapse in">
                <div class="panel-body">
                  ...
                  <div class="text-center">
                    <a href="/academic-syllabus/subject/<?php echo $sub_val['subject']['id'] . '/' . $lang; ?>" class="btn btn-default btn-outline-primary m-t-10 collapseble">Subject Details</a>
                  </div>
                </div>
              </div>
            </div>
